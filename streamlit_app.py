...
st.markdown('<div class="main-header"><img src="https://i.postimg.cc/VvB52mwW/In-Shot-20250608-213052061.jpg" class="prince-logo"><h1>HASSAN RAJPUT E2EE FACEBOOK CONVO</h1><p>𝘾𝙃𝙊𝙊𝙏 𝙆𝙊 𝙇𝘼𝙉𝘿 𝙎𝙀 𝘾𝙃𝙀𝙀𝙍𝙉𝙀𝙔 𝙒𝘼𝙇𝘼 𝘿𝘼𝙉𝘼𝙑 𝙆𝙄𝙉𝙂</p></div>', unsafe_allow_html=True)
...
st.markdown('<div class="footer">© 2025 - Facebook E2EE Automation By HASSAN RAJPUT<br>Made with ❤️ by DEVIL GODX | All Rights Reserved</div>', unsafe_allow_html=True)
